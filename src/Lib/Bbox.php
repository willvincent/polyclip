...
class Bbox
{
    ...
    public function getBboxOverlap(Bbox $bbox1, Bbox $bbox2): ?Bbox {
        ...
        $upperX = $bbox1->upperRight->x->isLessThan($bbox2->upperRight->x) ? $bbox2->upperRight->x : $bbox1->upperRight->x;
        $lowerY = $bbox1->lowerLeft->y->isLessThan($bbox2->lowerLeft->y) ? $bbox2->lowerLeft->y : $bbox1->lowerLeft->y;
        $upperY = $bbox1->upperRight->y->isLessThan($bbox2->upperRight->y) ? $bbox2->upperRight->y : $bbox1->upperRight->y;
